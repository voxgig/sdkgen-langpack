...
a path or a foreign registry, a Go `replace` reaching outside the repository, a
committed `go.work` at all, a Cargo `path` dependency leaving it, a committed symlink escaping
